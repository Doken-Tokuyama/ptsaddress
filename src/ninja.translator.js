ninja.translator = {
	...
	translations: {
		"en": {
			...
			"brainalertpassphrasewarning": "Warning: Choosing a strong passphrase is important to avoid brute force attempts to guess your passphrase and steal your protoshares.",
			...
			"detailconfirmsha256": "The text you entered is not a valid Private Key!\n\nWould you like to use the entered text as a passphrase and create a Private Key using a SHA256 hash of the passphrase?\n\nWarning: Choosing a strong passphrase is important to avoid brute force attempts to guess your passphrase and steal your protoshares.",
		...
		"es": {
			...
			"paperlabelbitcoinaddress": "Dirección Protoshare:",
			...
			"brainalertpassphrasewarning": "Aviso: Es importante escoger una contraseña fuerte para evitar ataques de fuerza bruta a fin de adivinarla y robar tus protoshares.",
			...
			"vanityalertinvalidinputcannotmultiple": "Entrada no válida. No se puede multiplicar dos claves públicas. Seleccione 'Añadir' para agregar dos claves públicas para obtener una dirección protoshare.",
			...
			"brainlabelbitcoinaddress": "Dirección Protoshare:",
		...
		"fr": {
			...
			"paperlabelbitcoinaddress": "Adresse Protoshare:",
			...
			"brainalertpassphrasewarning": "Attention: Choisir un mot de passe solide est important pour vous protéger des attaques bruteforce visant à trouver votre mot de passe et voler vos Protoshares.",
			...
			"vanityalertinvalidinputcannotmultiple": "Entrée non valide. Il n'est pas possible de multiplier deux clés publiques. Sélectionner 'Ajouter' pour ajouter deux clés publiques pour obtenir une adresse Protoshare.",
			...
			"brainlabelbitcoinaddress": "Adresse Protoshare:",
		...
		"el": {
			...
			"paperlabelbitcoinaddress": "Διεύθυνση Protoshare:",
			...
			"brainalertpassphrasewarning": "Προσοχή: Είναι σημαντικό να επιλέξετε μια ισχυρή φράση κωδικό που θα σας προφυλάξει από απόπειρες παραβίασής της τύπου brute force και κλοπή των protoshares σας.",
			...
			"vanityalertinvalidinputcannotmultiple": "Μη έγκυρη εισαγωγή. Δεν είναι δυνατός ο πολλαπλασιασμός δύο Δημόσιων Κλειδιών. Επιλέξτε 'Πρόσθεση' για να προσθέσετε δύο Δημόσια Κλειδιά για δημιουργία μίας Διεύθυνσης Protoshare.",
			...
			// header and menu html
			"tagline": "Δημιουργός Διευθύνσεων Protoshare, ανοικτού κώδικα Javascript",
			"generatelabelbitcoinaddress": "Δημιουργία Διεύθυνσης Protoshare...",
			...
			"footerlabeltranslatedby": "Μετάφραση: <a href='http://ProtoshareX.gr/'><b>ProtoshareX.gr</b></a> 1BitcoiNxkUPcTFxwMqxhRiPEiQRzYskf6",
			"footerlabelpgp": "PGP",
			...
			"brainlabelbitcoinaddress": "Διεύθυνση Protoshare:",
			...
			"vanitylabelbitcoinaddress": "Vanity Διεύθυνση Protoshare:",
